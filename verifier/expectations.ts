...
export const EXPECTED_FAIL: Xfail[] = [
  ...
  { file: "tests/e2e/corpus/provenance/ai-card.html", check: "roundtrip", reason: FIRST_SAVE_NORM },
  { file: "tests/e2e/corpus/real-career/decision-thesis.html", check: "roundtrip", reason: FIRST_SAVE_NORM },
  { file: "tests/e2e/corpus/real-career/project-deep-dives.html", check: "roundtrip", reason: FIRST_SAVE_NORM },
  { file: "tests/e2e/corpus/real-published/adamw.html", check: "roundtrip", reason: FIRST_SAVE_NORM },
  { file: "tests/e2e/corpus/real-published/layernorm-vs-rmsnorm.html", check: "roundtrip", reason: FIRST_SAVE_NORM },
  { file: "tests/e2e/corpus/real-published/tokenization.html", check: "roundtrip", reason: FIRST_SAVE_NORM },
  { file: "tests/e2e/corpus/styling-source/inline-only.html", check: "roundtrip", reason: FIRST_SAVE_NORM },
];
